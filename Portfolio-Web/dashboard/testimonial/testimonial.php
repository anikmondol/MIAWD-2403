                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../public/testimonial/<?= $testimonial['image'] ?>" alt="testimonial image" style="width: 70px; height: 70px; object-fit: cover;">
                                        </td>
                                        <td><?= $testimonial['title'] ?></td>
                                        <td><a href="store.php?status_id=<?= $testimonial['id'] ?>" class=" p-2 <?= ($testimonial['status'] == 'deactive') ? 'badge bg-danger text-white' : 'badge bg-success  text-white'; ?>">
                                                <?= $testimonial['status'] ?>
                                            </a></td>
                                        <td>
                                            <div class="d-flex justify-content-evenly align-items-center">
                                                ...
                                                <a href="./store.php?delate_id=<?= $testimonial['id'] ?>">
